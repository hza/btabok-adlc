...
export const NODES: NodeData[] = [
  ...
  { id:'n10', phase:'planning',        num:'19', title:'Architecture Hypothesis Canvas',       subtitle:'Validates uncertain decisions through situation, hypothesis, experiment design, success measures, and value impact',                     link:'https://iasa-global.github.io/btabok/architecture_hypothesis_card.html', badge:'BTABoK', importance:'high'},
  { id:'n11', phase:'planning',        num:'20', title:'QATT Card',                            subtitle:'Quality attribute scenario: stimulus, environment, measurable response, trade-offs, and architectural tactics',                link:'https://iasa-global.github.io/btabok/qatt_card.html',                    badge:'BTABoK', note:'One card per scenario', recurring:true, importance:'extra'},
