...
export const NODES: NodeData[] = (([
  ...
  { id:'ng5', phase:'strategy',  title:'Stakeholder Management',              subtitle:'Architect Stakeholder Canvas · Power-Interest Grid', badge:'BTABoK', note:'Collapsed group — toggle groups in top bar to expand individual cards', importance:2, role:'group'},
  { id:'n03', phase:'strategy', title:'Architect Stakeholder Canvas',         subtitle:'Business and technology stakeholders mapped across external, consumer, provider, and partner roles relative to the architect team',                   link:'https://iasa-global.github.io/btabok/architect_stakeholder_canvas.html',   badge:'BTABoK', note:'Update when stakeholder roles or ownership change across the engagement', importance:2, role:'item', groupId:'ng5'},
  { id:'n04', phase:'strategy', title:'Power-Interest Grid',                  subtitle:'2×2 grid of stakeholders by influence and interest to prioritize engagement and ensure critical sign-offs',                     link:'https://iasa-global.github.io/btabok/power_interest_grid.html',                                                               badge:'BTABoK', note:'Place each stakeholder in one quadrant; revisit after org changes or major decisions', importance:1, role:'item', groupId:'ng5'},
  { id:'ng6', phase:'strategy',  title:'Strategic Direction',                 subtitle:'Business Case · OKR Card', badge:'BTABoK', note:'Collapsed group — toggle groups in top bar to expand individual cards', importance:3, role:'group'},
  { id:'n05', phase:'strategy', title:'Business Case (NABC Card)',            subtitle:'Business case structured around need, approach, benefits, costs, ROI, and risks',                         link:'https://iasa-global.github.io/btabok/business_case_nabc_card.html',                                                                badge:'BTABoK', note:'Gate artifact — architecture must not proceed without an approved business case', importance:3, role:'item', groupId:'ng6'},
  { id:'ng7', phase:'strategy',  title:'Architecture Governance',             subtitle:'Architecture Principles · Architecture Definition Canvas', badge:'BTABoK', note:'Collapsed group — toggle groups in top bar to expand individual cards', importance:3, role:'group'},
  { id:'n06', phase:'strategy', title:'Architecture Principles',              subtitle:'Guiding rules linking business goals to architectural choices, each with rationale, testable criteria, and implications', link:'https://iasa-global.github.io/btabok/principles.html',  badge:'BTABoK', note:'BTABoK Principles topic — no canvas; maintain as a structured registry', importance:3, role:'item', groupId:'ng7'},
  { id:'n23', phase:'strategy', title:'OKR Card',                             subtitle:'Strategic goal defined through measurable key results traceable to architecture decisions',      link:'https://iasa-global.github.io/btabok/okr_card.html',                      badge:'BTABoK', note:'One card per strategic objective; link each key result to at least one ADR or capability', multiple:true, importance:2, role:'item', groupId:'ng6'},
  ...
  { id:'ng10', phase:'planning', title:'Design Exploration',                  subtitle:'Architecture Hypothesis Canvas · Solution Design Canvas', badge:'BTABoK', note:'Collapsed group — toggle groups in top bar to expand individual cards', importance:2, role:'group'},
  { id:'n10', phase:'planning', title:'Architecture Hypothesis Canvas',       subtitle:'Validates uncertain decisions through situation, hypothesis, experiment design, success measures, and value impact',                     link:'https://iasa-global.github.io/btabok/architecture_hypothesis_card.html', badge:'BTABoK', note:'Use when a decision carries significant uncertainty; run the experiment before the ADR is finalised', importance:1, role:'item', groupId:'ng10'},
  { id:'n13', phase:'planning', title:'Solution Design Canvas',               subtitle:'Solution exploration across business problem, outcomes, options, success metrics, and key assumptions',                               link:'https://iasa-global.github.io/btabok/solution_design_canvas.html',        badge:'BTABoK', note:'Spans Planning → Transformation continuously', importance:2, role:'item', groupId:'ng10'},
  { id:'ng8', phase:'planning',  title:'Roadmaps',                            subtitle:'Transition Roadmap Canvas · Layered Roadmap Canvas', badge:'BTABoK', note:'Collapsed group — toggle groups in top bar to expand individual cards', importance:2, role:'group'},
  { id:'n37', phase:'planning', title:'Transition Roadmap Canvas',               subtitle:'Migration path from current to target state: transition milestones, workstreams, dependencies, and risk mitigations per capability or system',  link:'https://iasa-global.github.io/btabok/transition_roadmap_canvas.html',     badge:'BTABoK', note:'One canvas per major capability or system migration', importance:2, role:'item', groupId:'ng8'},
  { id:'n07', phase:'planning', title:'Layered Roadmap Canvas',               subtitle:'Four-lane timeline of capability, technology, and people evolution from current to target state',              link:'https://iasa-global.github.io/btabok/layered_roadmap_canvas.html',        badge:'BTABoK', note:'Derived from Strategic and Transition Roadmaps; keep lane milestones in sync with ADRs', importance:1, role:'item', groupId:'ng8'},

  // BTABoK Transformation phase artifacts
  { id:'ng11', phase:'transformation', title:'Decisions',                          subtitle:'ADR Card · Architecture Decision Cascade Card', badge:'BTABoK', note:'Collapsed group — toggle groups in top bar to expand individual cards', importance:3, role:'group'},
  { id:'n14', phase:'transformation', title:'ADR Card',                             subtitle:'Architectural decision record: context, options considered, rationale, consequences, status, and ASR traceability',                  link:'https://iasa-global.github.io/btabok/architecture_decision_record.html',                                                                                             badge:'BTABoK', note:'Core — new ADR for every significant decision in Planning and Transformation', multiple:true, importance:3, role:'item', groupId:'ng11'},
  { id:'n15', phase:'transformation', title:'Architecture Decision Cascade Card',   subtitle:'Secondary decisions and downstream consequences flowing from a primary ADR',                   link:'https://iasa-global.github.io/btabok/architecture_decision_cascade_card.html', badge:'BTABoK', note:'Core — one Cascade Card per ADR, in both phases', multiple:true, importance:2, role:'item', groupId:'ng11'},
  { id:'ng13', phase:'transformation', title:'Domain & Services',                  subtitle:'Bounded Context Canvas · Service Interface Design Canvas', badge:'DDD', note:'Collapsed group — toggle groups in top bar to expand individual cards', importance:2, role:'group'},
  { id:'n16', phase:'transformation', title:'Bounded Context Canvas',               subtitle:'Inside-out domain partition within the system boundary: ubiquitous language, upstream/downstream dependencies, and team ownership — one per subdomain, defined after the Context View',                       link:'https://github.com/ddd-crew/bounded-context-canvas',                                                                 badge:'DDD', note:'One per bounded context', multiple:true, importance:2, role:'item', groupId:'ng13'},
  { id:'ng12', phase:'transformation', title:'Architecture Views',                 subtitle:'Application View · Physical View · Process View · Information View', badge:'BTABoK', note:'Collapsed group — toggle groups in top bar to expand individual cards', importance:3, role:'group'},
  { id:'n28', phase:'transformation', title:'Application View Card',                subtitle:'System decomposed into containers and components - use C4 L2/L3 Diagram', link:'https://c4model.com/#ContainerDiagram',                               badge:'BTABoK', descr:'Decomposes the solution into containers and components using C4 Level 2 and Level 3 diagrams. Maps bounded contexts to containers, defines service interfaces, and links containers to deployment nodes. Bridges the high-level context view and the infrastructure deployment view.', note:'Rename Context View Card to Application View Card', multiple:true, importance:3, role:'item', groupId:'ng12'},
  { id:'n17', phase:'transformation', title:'Service Interface Design Canvas',      subtitle:'Outside-in service spec: value proposition, consumers, interactions, SLAs, dependencies, quality attributes, and consumption economics',                       link:'https://iasa-global.github.io/btabok/service_interface_design_canvas.html',     badge:'BTABoK', note:'One canvas per service, API, or product delivered by a team', multiple:true, importance:2, role:'item', groupId:'ng13'},
  { id:'n18', phase:'transformation', title:'Physical View Card',                   subtitle:'Components mapped to nodes, networks, environments — use C4 Deployment or UML Deployment Diagram',           link:'https://c4model.com/#DeploymentDiagram',                                                                             badge:'BTABoK', note:'Rename Context View Card to Physical View Card', multiple:true, importance:2, role:'item', groupId:'ng12'},
  ...
  { id:'n20', phase:'transformation', title:'Process View Card',                    subtitle:'Time-ordered message flow for key use cases. For sequence / scenario view use UML Sequence or C4 Dynamic Diagram',                  link:'https://c4model.com/#DynamicDiagram',                                                                                badge:'BTABoK', note:'Rename Context View Card to Process View Card.', multiple:true, importance:1, role:'item', groupId:'ng12'},
  ...
  { id:'n39', phase:'transformation', title:'Information View Card',                subtitle:'Data entities, state transitions, storage semantics, and information lifecycle. Ensures data integrity.',                                      link:'https://pubs.opengroup.org/architecture/togaf9-doc/arch/chap09.html',        badge:'TOGAF', note:'BTABoK gap: data viewpoint — use TOGAF Data Architecture. Maps data to bounded contexts and containers.', multiple:true, external:true, importance:3, role:'item', groupId:'ng12'},
