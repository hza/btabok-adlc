...
export const NODES: NodeData[] = [
  ...
  { id:'n01', phase:'innovation',     num:'01', title:'Business Model Canvas',                subtitle:'One-page visual of how the organization creates, delivers, and captures value',                link:'https://iasa-global.github.io/btabok/business_model_canvas.html',                badge:'BTABoK', importance:2},
  { id:'n02', phase:'innovation',       num:'02', title:'Business Capability Canvas',         subtitle:'Hierarchical capability map within value streams; identifies bottlenecks and guides strategic investment',                 link:'https://iasa-global.github.io/btabok/business_capability_canvas.html',  badge:'BTABoK', importance:2},
  { id:'n24', phase:'innovation',       num:'03', title:'Capability Card',                    subtitle:'Maturity assessment per capability: outcomes, KPIs, people/process/technology, strategic impact, and gaps',          link:'https://iasa-global.github.io/btabok/capability_card.html',  badge:'BTABoK', recurring:true, importance:1},
  { id:'n25', phase:'innovation',       num:'04', title:'Risk Methods Cards',                 subtitle:'SWOT analysis, Risk Register, Risk Matrix, and Controls Testing — identify, rate, and govern risks',     link:'https://iasa-global.github.io/btabok/risk_methods.html',             badge:'BTABoK', note:'Feed into ADRs and ASRs', recurring:true, importance:2},
  { id:'n31', phase:'innovation',       num:'05', title:'Value Stream Map',                   subtitle:'End-to-end steps, handoffs, and wait times in value delivery; exposes waste and bottlenecks capability maps miss',                      link:'https://iasa-global.github.io/btabok/value_stream.html',             badge:'BTABoK', importance:2},
  { id:'n32', phase:'innovation',       num:'06', title:'Customer Journey Map',               subtitle:'Customer experience across touchpoints, channels, and emotions; surfaces pain points and unmet needs that drive architecture requirements',                      link:'https://iasa-global.github.io/btabok/customer_journey_map.html',    badge:'BTABoK', importance:1},
  ...
  { id:'n03', phase:'strategy',       num:'09', title:'Architect Stakeholder Canvas',         subtitle:'Business and technology stakeholders mapped across external, consumer, provider, and partner roles relative to the architect team',                   link:'https://iasa-global.github.io/btabok/architect_stakeholder_canvas.html',   badge:'BTABoK', importance:2},
  { id:'n04', phase:'strategy',       num:'10', title:'Power-Interest Grid',                  subtitle:'2×2 grid of stakeholders by influence and interest to prioritize engagement and ensure critical sign-offs',                     link:'https://iasa-global.github.io/btabok/power_interest_grid.html',                                                               badge:'BTABoK', importance:1},
  { id:'n05', phase:'strategy',       num:'11', title:'Business Case (NABC Card)',            subtitle:'Business case structured around need, approach, benefits, costs, ROI, and risks',                         link:'https://iasa-global.github.io/btabok/business_case_nabc_card.html',                                                                badge:'BTABoK', importance:3},
  { id:'n23', phase:'strategy',       num:'12', title:'OKR Card',                             subtitle:'Strategic goal defined through measurable key results traceable to architecture decisions',      link:'https://iasa-global.github.io/btabok/okr_card.html',                      badge:'BTABoK', recurring:true, importance:2},
  ...
  { id:'n30', phase:'strategy',       num:'14', title:'Strategic Roadmap Canvas',             subtitle:'Portfolio IT direction: vision, initiatives, timelines, value/complexity/compliance, and cross-stream dependencies', link:'https://iasa-global.github.io/btabok/strategic_roadmap_canvas.html',      badge:'BTABoK', importance:2},

  // BTABoK Planning phase artifacts
  { id:'n07', phase:'planning',       num:'15', title:'Layered Roadmap Canvas',               subtitle:'Four-lane timeline of capability, technology, and people evolution from current to target state',              link:'https://iasa-global.github.io/btabok/layered_roadmap_canvas.html',        badge:'BTABoK', importance:1},
  ...
  { id:'n10', phase:'planning',        num:'19', title:'Architecture Hypothesis Canvas',       subtitle:'Validates uncertain decisions through situation, hypothesis, experiment design, success measures, and value impact',                     link:'https://iasa-global.github.io/btabok/architecture_hypothesis_card.html', badge:'BTABoK', importance:1},
  { id:'n11', phase:'planning',        num:'20', title:'QATT Card',                            subtitle:'Quality attribute scenario: stimulus, environment, measurable response, trade-offs, and architectural tactics',                link:'https://iasa-global.github.io/btabok/qatt_card.html',                    badge:'BTABoK', note:'One card per scenario', recurring:true, importance:2},
  { id:'n12', phase:'transformation', num:'21', title:'Architecture Definition Canvas',       subtitle:'Defines what architecture means for the engagement and its value to each stakeholder group',                 link:'https://iasa-global.github.io/btabok/architecture_definition_canvas.html', badge:'BTABoK', importance:1},
  { id:'n13', phase:'transformation', num:'22', title:'Solution Design Canvas',               subtitle:'Solution exploration across business problem, outcomes, options, success metrics, and key assumptions',                               link:'https://iasa-global.github.io/btabok/solution_design_canvas.html',        badge:'BTABoK', note:'Spans Planning → Transformation continuously', importance:2},
  { id:'n14', phase:'transformation', num:'23', title:'ADR Card',                             subtitle:'Architectural decision record: context, options considered, rationale, consequences, status, and ASR traceability',                  link:'https://iasa-global.github.io/btabok/architecture_decision_record.html',                                                                                             badge:'BTABoK', note:'Core — new ADR for every significant decision in Planning and Transformation', recurring:true, importance:3},
  ...
  { id:'n16', phase:'transformation', num:'25', title:'Bounded Context Canvas',               subtitle:'DDD boundaries, language, dependencies',                       link:'https://github.com/ddd-crew/bounded-context-canvas',                                                                 badge:'DDD', note:'One per bounded context', recurring:true, importance:2},
  ...
  { id:'n17', phase:'transformation', num:'27', title:'Service Interface Design Canvas',      subtitle:'Outside-in service spec: value proposition, consumers, interactions, SLAs, dependencies, quality attributes, and consumption economics',                       link:'https://iasa-global.github.io/btabok/service_interface_design_canvas.html',     badge:'BTABoK', note:'One canvas per service, API, or product delivered by a team', recurring:true, importance:2},
  { id:'n18', phase:'transformation', num:'28', title:'Deployment / Infrastructure View',     subtitle:'Components mapped to nodes, networks, environments',           link:'https://c4model.com/#DeploymentDiagram',                                                                             badge:'C4', note:'BTABoK gap: physical view (Views & Viewpoints) — use C4 Deployment or UML Deployment Diagram', external:true, importance:2},
  ...
  { id:'n20', phase:'transformation', num:'30', title:'Sequence / Scenario View',             subtitle:'Time-ordered message flow for key use cases',                  link:'https://c4model.com/#DynamicDiagram',                                                                                badge:'C4', note:'BTABoK gap: scenario view (Views & Viewpoints) — use UML Sequence or C4 Dynamic Diagram', external:true, recurring:true, importance:1},
  ...
  { id:'n22', phase:'utilize',        num:'32', title:'Benefits Realization View Canvas',     subtitle:'Architecture investments mapped to measurable business benefits, costs, and technical debt',          link:'https://iasa-global.github.io/btabok/benefits_realization_view_canvas.html', badge:'BTABoK', importance:2 },
];
