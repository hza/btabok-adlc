...
export const NODES: NodeData[] = (([
  ...
  { id:'n09', phase:'planning', title:'ASR Card',                             subtitle:'Requirements that fundamentally shape system design, bridging business goals to technical implementation; every ADR traces to an ASR',                     link:'https://iasa-global.github.io/btabok/asr_card.html',                     badge:'BTABoK', note:'One card per architecturally significant requirement', multiple:true, importance:3},
  { id:'n11', phase:'planning', title:'QATT Card',                            subtitle:'Quality attribute scenario: stimulus, environment, measurable response, trade-offs, and architectural tactics',                link:'https://iasa-global.github.io/btabok/qatt_card.html',                    badge:'BTABoK', note:'One card per scenario', multiple:true, importance:2},
  ...
  { id:'n10', phase:'planning', title:'Architecture Hypothesis Canvas',       subtitle:'Validates uncertain decisions through situation, hypothesis, experiment design, success measures, and value impact',                     link:'https://iasa-global.github.io/btabok/architecture_hypothesis_card.html', badge:'BTABoK', note:'Use when a decision carries significant uncertainty; run the experiment before the ADR is finalised', importance:1},
  ...
  { id:'n37', phase:'planning', title:'Transition Roadmap Canvas',               subtitle:'Migration path from current to target state: transition milestones, workstreams, dependencies, and risk mitigations per capability or system',  link:'https://iasa-global.github.io/btabok/transition_roadmap_canvas.html',     badge:'BTABoK', note:'One canvas per major capability or system migration', importance:2},
  { id:'n07', phase:'planning', title:'Layered Roadmap Canvas',               subtitle:'Four-lane timeline of capability, technology, and people evolution from current to target state',              link:'https://iasa-global.github.io/btabok/layered_roadmap_canvas.html',        badge:'BTABoK', note:'Derived from Strategic and Transition Roadmaps; keep lane milestones in sync with ADRs', importance:1},

  // BTABoK Transformation phase artifacts
  { id:'n14', phase:'transformation', title:'ADR Card',                             subtitle:'Architectural decision record: context, options considered, rationale, consequences, status, and ASR traceability',                  link:'https://iasa-global.github.io/btabok/architecture_decision_record.html',                                                                                             badge:'BTABoK', note:'Core — new ADR for every significant decision in Planning and Transformation', multiple:true, importance:3},
  { id:'n15', phase:'transformation', title:'Architecture Decision Cascade Card',   subtitle:'Secondary decisions and downstream consequences flowing from a primary ADR',                   link:'https://iasa-global.github.io/btabok/architecture_decision_cascade_card.html', badge:'BTABoK', note:'Core — one Cascade Card per ADR, in both phases', multiple:true, importance:2},
  { id:'n16', phase:'transformation', title:'Bounded Context Canvas',               subtitle:'Inside-out domain partition within the system boundary: ubiquitous language, upstream/downstream dependencies, and team ownership — one per subdomain, defined after the Context View',                       link:'https://github.com/ddd-crew/bounded-context-canvas',                                                                 badge:'DDD', note:'One per bounded context', multiple:true, importance:2},
  { id:'n28', phase:'transformation', title:'Application View Card',                subtitle:'System decomposed into containers and components - use C4 L2/L3 Diagram', link:'https://c4model.com/#ContainerDiagram',                               badge:'BTABoK', descr:'Decomposes the solution into containers and components using C4 Level 2 and Level 3 diagrams. Maps bounded contexts to containers, defines service interfaces, and links containers to deployment nodes. Bridges the high-level context view and the infrastructure deployment view.', note:'Rename Context View Card to Application View Card', multiple:true, importance:3},
  { id:'n17', phase:'transformation', title:'Service Interface Design Canvas',      subtitle:'Outside-in service spec: value proposition, consumers, interactions, SLAs, dependencies, quality attributes, and consumption economics',                       link:'https://iasa-global.github.io/btabok/service_interface_design_canvas.html',     badge:'BTABoK', note:'One canvas per service, API, or product delivered by a team', multiple:true, importance:2},
  { id:'n18', phase:'transformation', title:'Physical View Card',                   subtitle:'Components mapped to nodes, networks, environments — use C4 Deployment or UML Deployment Diagram',           link:'https://c4model.com/#DeploymentDiagram',                                                                             badge:'BTABoK', note:'Rename Context View Card to Deployment View Card', multiple:true, importance:2},
