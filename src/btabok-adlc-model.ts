...
export const EDGES: EdgeData[] = [
  ...
  { id:'e20',  from:'n10', to:'n14', label:'Empirical validation substantiates architectural decisions',     importance:3,},
  ...
  { id:'e36',  from:'n21', to:'n22', label:'Technical debt degrades realized business value',                importance:3,},
  ...
  { id:'e54',  from:'n22', to:'n23', label:'Realized benefits verify OKR achievement',                       importance:3,},
  ...
  { id:'e68',  from:'n26', to:'n17', label:'Customer touchpoints define service interface requirements',     importance:3,},
  ...
  { id:'e76',  from:'n28', to:'n17', label:'Containers implement and expose service contracts',              importance:3 },
  { id:'e77',  from:'n28', to:'n18', label:'Containers are allocated to physical deployment targets',        importance:3 },
  ...
  { id:'e110', from:'n20', to:'n14', label:'System interaction patterns mandate design decisions',           importance:3 },
  ...
  { id:'e89',  from:'n31', to:'n16', label:'Value flow delineates bounded context boundaries',               importance:3 },
  ...
  { id:'e104', from:'n35', to:'n32', label:'Empathy analysis provides emotional context for journey touchpoints',importance:3,},
  ...
  { id:'e115', from:'n37', to:'n14', label:'Migration strategies are recorded as formal architectural decisions',importance:3,},
