...
export const NODES: NodeData[] = (([
  ...
  { id:'n12', phase:'transformation', title:'Architecture Definition Canvas',       subtitle:'Defines what architecture means for the engagement and its value to each stakeholder group',                 link:'https://iasa-global.github.io/btabok/architecture_definition_canvas.html', badge:'BTABoK', importance:1},
  { id:'n13', phase:'transformation', title:'Solution Design Canvas',               subtitle:'Solution exploration across business problem, outcomes, options, success metrics, and key assumptions',                               link:'https://iasa-global.github.io/btabok/solution_design_canvas.html',        badge:'BTABoK', note:'Spans Planning → Transformation continuously', importance:2},
  ...
  { id:'n16', phase:'transformation', title:'Bounded Context Canvas',               subtitle:'DDD boundaries, language, dependencies',                       link:'https://github.com/ddd-crew/bounded-context-canvas',                                                                 badge:'DDD', note:'One per bounded context', recurring:true, importance:2},
