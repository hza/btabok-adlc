    ...
    <div style={style}>
      ...
      <div style={{ fontWeight: 700, fontSize: 15, color: '#1E293B', marginBottom: 12 }}>Legend</div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
            <span style={{ fontSize: 13, fontWeight: 600, color: '#94A3B8', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Edge types</span>
            {onToggleAllEdgeTypes && (
              <div style={{ display: 'flex', gap: 4 }}>
                <button
                  onClick={() => onToggleAllEdgeTypes(false)}
                  title="Hide all edge types"
                  style={{ background: 'none', border: '1px solid #E2E8F0', borderRadius: 4, cursor: 'pointer', padding: '2px 4px', color: '#94A3B8', display: 'flex', alignItems: 'center' }}
                >
                ...
                <button
                  onClick={() => onToggleAllEdgeTypes(true)}
