  ...
  return (
    <div style={{
      ...
      <span style={{ fontWeight: 800, fontSize: 16, fontFamily: 'sans-serif', letterSpacing: '-0.5px', marginRight: 4, display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <span className="topbar-title-full">BTABoK Architecture Development Life Cycle</span>
        <span className="topbar-title-short">BTABoK ADLC</span>
      </span>
      <span style={{ marginLeft: 'auto' }}/>

      {/* controls hidden on small screens */}
      <div className="topbar-hide-sm" style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        <Divider/>
...
function Divider({ className }: { className?: string }) {
  return <div className={className} style={{ width: 1, height: 20, background: '#334155', flexShrink: 0 }}/>;
}
