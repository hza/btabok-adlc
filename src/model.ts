...
export const NODES: NodeData[] = [
  ...
  { id:'n07', phase:'strategy',       num:'11', title:'Layered Roadmap Canvas',               subtitle:'Four-lane view of business capability changes, technology services, and people evolution across time from current to target state',              link:'https://iasa-global.github.io/btabok/layered_roadmap_canvas.html',        badge:'BTABoK', importancy:1, importancyReason:'Transforms architecture intent into funded, sequenced delivery — without it strategy remains aspirational and unbudgeted'},
