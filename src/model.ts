...
export const NODES: NodeData[] = [
  ...
  { id:'n24', phase:'strategy',       num:'02a',title:'Capability Card',         subtitle:'Current-state maturity heat map, gap identification',          link:'https://iasa-global.github.io/btabok/capability_card.html',  badge:'BTABoK',  note:'BTABoK Capability Assessment — assess each capability for maturity and strategic gap'},
  ...
  { id:'n25', phase:'strategy',       num:'05c',title:'Risk Methods',                         subtitle:'Risk identification, probability × impact per capability',     link:'https://iasa-global.github.io/btabok/risk_methods.html',             badge:'BTABoK',  note:'BTABoK Risk Methods — identify architecture risks early, feed into ADRs and ASRs'},
  ...
  { id:'n26', phase:'planning',       num:'08a',title:'Service Blueprint Canvas',             subtitle:'Customer journey, front/back-stage systems, failure points',   link:'https://iasa-global.github.io/btabok/service_blueprint_canvas.html',      badge:'BTABoK', note:'BTABoK business/core canvas — service scenario blueprinting fits Planning, near Context View'},
