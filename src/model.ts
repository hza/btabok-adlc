...
export const NODES: NodeData[] = [
  ...
  { id:'n23', phase:'strategy',       num:'05a',title:'OKR Card',                              subtitle:'Objectives & key results, measurable strategic outcomes',      link:'https://iasa-global.github.io/btabok/okr_card.html',                      badge:'Core',           badgeColor:'purple',  note:'Value Model — bridges strategy to measurable outcomes; links to Strategy Scorecard and Benefits Card'},
  { id:'n25', phase:'strategy',       num:'05c',title:'Risk Methods Card',                    subtitle:'Risk identification, probability × impact per capability',     link:'https://iasa-global.github.io/btabok/risk_methods_card.html',             badge:'Core',           badgeColor:'purple',  note:'BTABoK Risk Methods — identify architecture risks early, feed into ADRs and ASRs'},
  { id:'n26', phase:'strategy',       num:'05d',title:'Service Blueprint Canvas',              subtitle:'Customer journey, front/back-stage systems, failure points',   link:'https://iasa-global.github.io/btabok/service_blueprint_canvas.html',      badge:'Core',       badgeColor:'purple'},
