...
export const NODES: NodeData[] = [
  ...
  { id:'n06', phase:'strategy',       num:'06', title:'Architecture Principles Register',     subtitle:'Principles from capabilities and constraints, linked to ADRs', link:'https://iasa-global.github.io/btabok/principles.html',  badge:'BTABoK', note:'BTABoK Principles topic — no canvas; maintain as a structured register'},
