...
export const NODES: NodeData[] = [
  ...
  { id:'n18', phase:'transformation', num:'28', title:'Deployment / Infrastructure View',     subtitle:'Components mapped to nodes, networks, environments',           link:'https://c4model.com/#DeploymentDiagram',                                                                             badge:'C4', importancy:1, importancyReason:'Architecture exists in a physical environment — without this view, operational concerns (latency, failure domains, compliance) are invisible until production', note:'BTABoK gap: physical view (Views & Viewpoints) — use C4 Deployment or UML Deployment Diagram', external:true},
  { id:'n29', phase:'transformation', num:'29', title:'Security Architecture View',           subtitle:'Threat model, trust zones, security controls, attack surface', link:'https://owasp.org/www-community/Threat_Modeling',                        badge:'OWASP', importancy:1, importancyReason:'Security bolted on after design is a compliance liability and a re-architecture event — threat modelling must happen at transformation phase', note:'BTABoK gap: security viewpoint — use STRIDE + security zone diagram; critical for compliance', external:true},
