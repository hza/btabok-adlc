...
export const NODES: NodeData[] = [
  ...
  { id:'n29', phase:'transformation', num:'24', title:'Security Architecture View',           subtitle:'Threat model, trust zones, security controls, attack surface', link:'https://owasp.org/www-community/Threat_Modeling',                        badge:'OWASP', importancy:1, importancyReason:'Security bolted on after design is a compliance liability and a re-architecture event — threat modelling must happen at transformation phase', note:'BTABoK gap: security viewpoint — use STRIDE + security zone diagram; critical for compliance', external:true},
