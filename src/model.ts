...
export const NODES: NodeData[] = [
  { id:'n01', phase:'innovation',     num:'01', title:'Business Model Canvas',                subtitle:'Value proposition, customers, revenue streams',                link:'https://iasa-global.github.io/btabok/business_model_canvas.html',                badge:'Core SCA',           badgeColor:'purple', x:60,   y:60   },
  { id:'n02', phase:'strategy',       num:'02', title:'Business Capability Canvas',           subtitle:'What the business does, capability hierarchy',                 link:'https://iasa-global.github.io/btabok/business_capability_canvas.html',  badge:'Core SCA',           badgeColor:'purple', x:60,   y:230  },
  { id:'n03', phase:'strategy',       num:'03', title:'Architect Stakeholder Canvas',         subtitle:'All parties, engagement levels, governance',                   link:'https://iasa-global.github.io/btabok/architect_stakeholder_canvas.html',   badge:'Core SCA',           badgeColor:'purple', x:300,  y:230  },
  { id:'n04', phase:'strategy',       num:'04', title:'Power-Interest Grid',                  subtitle:'2×2 prioritisation by power and interest',                    link:'https://iasa-global.github.io/btabok/power_interest_grid.html',                                                               badge:'Core SCA',           badgeColor:'purple', x:540,  y:230  },
  { id:'n05', phase:'strategy',       num:'05', title:'Business Case (NABC Card)',            subtitle:'Need, approach, benefit, competition',                         link:'https://iasa-global.github.io/btabok/nabc_card.html',                                                                badge:'Core SCA',           badgeColor:'purple', x:780,  y:230  },
  { id:'n06', phase:'strategy',       num:'06', title:'Architecture Principles Register',     subtitle:'Principles from capabilities and constraints, linked to ADRs', link:'https://iasa-global.github.io/btabok/architecture_principles_canvas.html',  badge:'Architecture practice', badgeColor:'green', note:'BTABoK Principles topic — no SCA canvas; maintain as a structured register', x:60, y:400 },
  { id:'n07', phase:'strategy',       num:'07', title:'Layered Roadmap Canvas',               subtitle:'Current → target state, phased investment gates',              link:'https://iasa-global.github.io/btabok/layered_roadmap_canvas.html',        badge:'Core SCA',           badgeColor:'purple', x:300,  y:400  },
  { id:'n08', phase:'planning',       num:'08', title:'Context View Card',                    subtitle:'System boundary, external actors, interfaces',                 link:'https://iasa-global.github.io/btabok/context_view_card.html',           badge:'Core SCA',           badgeColor:'purple', x:60,   y:590  },
  { id:'n09', phase:'planning',       num:'09', title:'ASR Card',                             subtitle:'Architecturally significant requirements',                     link:'https://iasa-global.github.io/btabok/asr_card.html',                     badge:'Core SCA',           badgeColor:'purple', x:300,  y:590  },
  { id:'n10', phase:'planning',       num:'10', title:'Architecture Hypothesis Canvas',       subtitle:'Assumption → experiment → success metric',                    link:'https://iasa-global.github.io/btabok/architecture_hypothesis_canvas.html', badge:'Core SCA',           badgeColor:'purple', x:540,  y:590  },
  { id:'n11', phase:'planning',       num:'11', title:'QATT Card',                            subtitle:'Stimulus–response quality attribute scenarios',                link:'https://iasa-global.github.io/btabok/qatt_card.html',                    badge:'Software SCA',       badgeColor:'teal',   x:780,  y:590  },
  { id:'n12', phase:'planning',       num:'12', title:'Architecture Definition Canvas',       subtitle:'Scope, principles, key decisions on one page',                 link:'https://iasa-global.github.io/btabok/architecture_definition_canvas.html', badge:'Core SCA',           badgeColor:'purple', x:60,   y:770  },
  { id:'n13', phase:'planning',       num:'13', title:'Solution Design Canvas',               subtitle:'Problem → options → hypotheses',                              link:'https://iasa-global.github.io/btabok/solution_design_canvas.html',        badge:'Solution SCA',       badgeColor:'coral',  note:'Spans Planning → Transformation continuously', x:300, y:770 },
  { id:'n14', phase:'planning',       num:'14', title:'Architecture Decision Record',         subtitle:'Options scored, chosen decision, trade-offs',                  link:'https://iasa-global.github.io/btabok/architecture_decision_record.html',                                                                                             badge:'Recurring',          badgeColor:'gray',   note:'Core SCA — new ADR for every significant decision in Planning and Transformation', recurring:true, x:540, y:770 },
  { id:'n15', phase:'planning',       num:'15', title:'Architecture Decision Cascade Card',   subtitle:'Downstream ripple effects of each decision',                   link:'https://iasa-global.github.io/btabok/architecture_decision_cascade_card.html', badge:'Recurring',      badgeColor:'gray',   note:'Core SCA — one Cascade Card per ADR, in both phases', recurring:true, x:780, y:770 },
  { id:'n16', phase:'transformation', num:'16', title:'Bounded Context Canvas',               subtitle:'DDD boundaries, language, dependencies',                      link:'https://github.com/ddd-crew/bounded-context-canvas',                                                                 badge:'Core SCA',           badgeColor:'purple', x:60,   y:980  },
  { id:'n17', phase:'transformation', num:'17', title:'Service Interface Design Canvas',      subtitle:'Operations, contracts, SLAs, consumers',                      link:'https://iasa-global.github.io/btabok/service_interface_canvas.html',     badge:'Software SCA',       badgeColor:'teal',   x:300,  y:980  },
  { id:'n18', phase:'transformation', num:'18', title:'Deployment / Infrastructure View',     subtitle:'Components mapped to nodes, networks, environments',           link:'https://c4model.com/#DeploymentDiagram',                                                                             badge:'External standard',  badgeColor:'amber',  note:'BTABoK gap: physical view (Views & Viewpoints) — use C4 Deployment or UML Deployment Diagram', external:true, x:540, y:980 },
  { id:'n19', phase:'transformation', num:'19', title:'Data / Information Architecture View', subtitle:'Entities, ownership, flows, persistence boundaries',           link:'https://iasa-global.github.io/btabok/information_architecture_view.html', badge:'External standard',  badgeColor:'amber',  note:'BTABoK gap: Information Architecture tag — use ERD or Data Flow Diagram', external:true, x:780, y:980 },
  { id:'n20', phase:'transformation', num:'20', title:'Sequence / Scenario View',             subtitle:'Time-ordered message flow for key use cases',                  link:'https://c4model.com/#DynamicDiagram',                                                                                badge:'External standard',  badgeColor:'amber',  note:'BTABoK gap: scenario view (Views & Viewpoints) — use UML Sequence or C4 Dynamic Diagram', external:true, x:1020, y:980 },
  { id:'n21', phase:'transformation', num:'21', title:'Technical Loan Request Card',          subtitle:'Debt as a loan: principal, interest, repayment plan',          link:'https://iasa-global.github.io/btabok/technical_loan_request_card.html',  badge:'Software SCA',       badgeColor:'teal',   x:60,   y:1160 },
  { id:'n22', phase:'utilize',        num:'22', title:'Benefits Realization View Canvas',     subtitle:'Decisions → enablers → measurable business benefits',         link:'https://iasa-global.github.io/btabok/benefits_realization_view_canvas.html', badge:'Software SCA',     badgeColor:'teal',   x:60,   y:1360 },
];
