...
export const NODES: NodeData[] = [
  ...
  { id:'n17', phase:'transformation', num:'23', title:'Service Interface Design Canvas',      subtitle:'Outside-in service spec: value proposition, consumers, interactions, SLAs, dependencies, quality attributes, and consumption economics',                       link:'https://iasa-global.github.io/btabok/service_interface_design_canvas.html',     badge:'BTABoK', importancy:1, importancyReason:'Contracts between services are the hardest things to change after deployment — explicit interface design prevents accidental coupling', note:'One canvas per service, API, or product delivered by a team', recurring:true},
