...
export const NODES: NodeData[] = [
  ...
  { id:'n01', phase:'innovation',     num:'01', title:'Business Model Canvas',                subtitle:'Condenses the entire business model onto one visual page to align stakeholders on how the organization creates, delivers, and captures value',                link:'https://iasa-global.github.io/btabok/business_model_canvas.html',                badge:'BTABoK', importancy:1, importancyReason:'Entry point for every engagement — without a shared business model, architecture has no anchor to value or customer outcomes'},
  { id:'n02', phase:'innovation',       num:'02', title:'Business Capability Canvas',           subtitle:'Hierarchical map of organizational capabilities within value streams; identifies bottlenecks and guides strategic investment',                 link:'https://iasa-global.github.io/btabok/business_capability_canvas.html',  badge:'BTABoK', importancy:1, importancyReason:'Defines what the business does independent of how — the foundation for all capability-driven investment and architecture decisions'},
  { id:'n24', phase:'innovation',       num:'03', title:'Capability Card',                      subtitle:'Per-capability maturity assessment: outcomes, KPIs, people/process/technology, strategic impact, and gap analysis',          link:'https://iasa-global.github.io/btabok/capability_card.html',  badge:'BTABoK', importancy:1, importancyReason:'Operationalises the capability map — without per-capability maturity assessment the canvas stays decorative and gaps go unaddressed', note:'BTABoK Capability Assessment — assess each capability for maturity and strategic gap', recurring:true},
  { id:'n25', phase:'innovation',       num:'04', title:'Risk Methods',                         subtitle:'Architectural risk identification, probability × consequence assessment, mitigation strategies, and treatment options across technology, financial, legal, and organizational risk types',     link:'https://iasa-global.github.io/btabok/risk_methods.html',             badge:'BTABoK', importancy:1, importancyReason:'Risk identified late becomes cost; identifying it at strategy phase keeps it as a decision input rather than an emergency response', note:'BTABoK Risk Methods — identify architecture risks early, feed into ADRs and ASRs', recurring:true},
  { id:'n31', phase:'innovation',       num:'04a', title:'Value Stream Map',                      subtitle:'End-to-end visualization of the steps, handoffs, and wait times required to deliver value to the customer; exposes waste and bottlenecks that capability maps alone miss',                      link:'https://iasa-global.github.io/btabok/value_stream.html',             badge:'BTABoK', importancy:1, importancyReason:'Connects business capabilities to actual value flow — without mapping the stream, architectural interventions target symptoms rather than the real delays and waste'},
  { id:'n32', phase:'innovation',       num:'04b', title:'Customer Journey Map',                  subtitle:'Visualizes the end-to-end experience of a customer across touchpoints, channels, and emotions to surface pain points and unmet needs driving architectural requirements',                      link:'https://iasa-global.github.io/btabok/customer_journey_map.html',    badge:'BTABoK', importancy:1, importancyReason:'Architecture that ignores customer experience optimises internal plumbing while leaving user pain unsolved; the journey map keeps the architecture customer-outcome anchored'},
  { id:'n33', phase:'innovation',       num:'04c', title:'JTBD Card',                              subtitle:'Captures the functional, emotional, and social jobs customers are trying to accomplish — independent of any solution — to anchor architecture to genuine customer needs rather than assumed features',  link:'https://iasa-global.github.io/btabok/jtbd_card.html',               badge:'BTABoK', importancy:1, importancyReason:'Architecture built around solutions rather than customer jobs optimises the wrong things; JTBD reframes every requirement as a job the customer is trying to get done', note:'One card per distinct customer job; identify functional, emotional, and social dimensions', recurring:true},
  { id:'n34', phase:'innovation',       num:'04d', title:'Customer Persona',                       subtitle:'Synthesizes research into a named, humanized profile of a target customer segment covering goals, frustrations, behaviours, and context to make customer needs concrete for architecture and design decisions', link:'https://iasa-global.github.io/btabok/persona_card.html',             badge:'BTABoK', importancy:1, importancyReason:'Architecture that abstracts away the human reduces real user goals to technical requirements; a concrete persona keeps design decisions grounded in actual behaviour patterns', note:'One persona per distinct customer segment or user type', recurring:true},

  // BTABoK Strategy phase artifacts
  { id:'n03', phase:'strategy',       num:'05', title:'Architect Stakeholder Canvas',         subtitle:'Maps demand (business) and supply (technology) stakeholders across external, consumer, provider, and partner roles relative to the architect team',                   link:'https://iasa-global.github.io/btabok/architect_stakeholder_canvas.html',   badge:'BTABoK', importancy:1, importancyReason:'Architecture that ignores stakeholders dies in review — mapping all parties and engagement levels is a prerequisite for governance and adoption'},
  { id:'n04', phase:'strategy',       num:'06', title:'Power-Interest Grid',                  subtitle:'2×2 grid mapping stakeholders by influence and interest to determine engagement strategy and prevent critical sign-offs being missed',                     link:'https://iasa-global.github.io/btabok/power_interest_grid.html',                                                               badge:'BTABoK', importancy:1, importancyReason:'Without prioritising who can block or champion decisions, stakeholder effort is misallocated and critical sign-offs get missed'},
  { id:'n05', phase:'strategy',       num:'07', title:'Business Case (NABC Card)',            subtitle:'Business case structured around need, approach, benefits, costs, ROI, and risks to justify architectural investment decisions',                         link:'https://iasa-global.github.io/btabok/business_case_nabc_card.html',                                                                badge:'BTABoK', importancy:1, importancyReason:'Architecture without a justified business case is a technology project, not a business investment — NABC forces the value argument up front'},
  { id:'n23', phase:'strategy',       num:'08', title:'OKR Card',                             subtitle:'Ambitious goal aligned to organizational strategy, defined through measurable key results and actionable steps traceable to architecture decisions',      link:'https://iasa-global.github.io/btabok/okr_card.html',                      badge:'BTABoK', importancy:1, importancyReason:'Value proof is a top BTABoK architect obligation — OKRs are the measurement mechanism that connects strategy to demonstrable outcomes', note:'One card per strategic objective', recurring:true},
  { id:'n06', phase:'strategy',       num:'09', title:'Architecture Principles',              subtitle:'Experiential guiding rules linking business goals to architectural choices; each principle has a rationale, testable criteria, and stated implications', link:'https://iasa-global.github.io/btabok/principles.html',  badge:'BTABoK', importancy:1, importancyReason:'Principles are the standing decisions that prevent every team from relitigating the same trade-offs — without them, governance is arbitrary', note:'BTABoK Principles topic — no canvas; maintain as a structured registry'},
  { id:'n30', phase:'strategy',       num:'10', title:'Strategic Roadmap Canvas',             subtitle:'Portfolio-level IT direction: vision, strategic initiatives, timelines, value/complexity/compliance assessments, and cross-stream dependencies', link:'https://iasa-global.github.io/btabok/strategic_roadmap_canvas.html',      badge:'BTABoK', importancy:1, importancyReason:'Bridges business vision and OKRs to a portfolio of IT initiatives — without it, the Layered Roadmap has no strategic anchor and initiatives compete without alignment' },

  // BTABoK Planning phase artifacts
  { id:'n07', phase:'planning',       num:'11', title:'Layered Roadmap Canvas',               subtitle:'Four-lane view of business capability changes, technology services, and people evolution across time from current to target state',              link:'https://iasa-global.github.io/btabok/layered_roadmap_canvas.html',        badge:'BTABoK', importancy:1, importancyReason:'Transforms architecture intent into funded, sequenced delivery — without it strategy remains aspirational and unbudgeted'},
  { id:'n08', phase:'planning',       num:'12', title:'Context View Card',                    subtitle:'Defines the solution boundary and its relationships with external systems, user groups, and stakeholders to align all parties on scope before design begins',                 link:'https://iasa-global.github.io/btabok/context_view_card.html',           badge:'BTABoK', importancy:1, importancyReason:'Establishes the system boundary before any design begins — misaligned scope is the most expensive planning mistake to fix later', descr:'Describes the solution by illustrating how it interacts within its broader environment. Defines boundaries relative to external entities (systems, user groups, stakeholders), maps integration points and dependencies, and fosters stakeholder alignment through a shared visualization of the solution ecosystem. Links to ASRs, ADRs, and downstream architectural views.', note:'Use UML or ArchiMate; document each external connection and data flow'},
  { id:'n26', phase:'planning',       num:'13', title:'Service Blueprint Canvas',             subtitle:'Maps customer actions, frontstage interactions, backstage processes, supporting technology, and failure points across the full service delivery chain',   link:'https://iasa-global.github.io/btabok/service_blueprint_canvas.html',      badge:'BTABoK', importancy:1, importancyReason:'Bridges customer experience to back-stage systems — the primary artifact for aligning service architecture with actual usage and failure modes', note:'One canvas per customer journey or service scenario', recurring:true},
  { id:'n09', phase:'planning',       num:'14', title:'ASR Card',                             subtitle:'Documents requirements that fundamentally shape system design, bridging business goals with technical implementation; every ADR traces to an ASR',                     link:'https://iasa-global.github.io/btabok/asr_card.html',                     badge:'BTABoK', importancy:1, importancyReason:'ASRs are the contractual interface between business needs and architecture decisions — every ADR must trace back to one', note:'One card per architecturally significant requirement', recurring:true},

  // BTABoK Transformation phase artifacts
  { id:'n10', phase:'transformation', num:'15', title:'Architecture Hypothesis Canvas',       subtitle:'Validates uncertain architecture decisions through five sections: situation, hypothesis, experiment design, success measures, and value impact',                     link:'https://iasa-global.github.io/btabok/architecture_hypothesis_card.html', badge:'BTABoK', importancy:2, importancyReason:'Valuable in lean/agile contexts for validating uncertain decisions, but conditional on methodology — not every engagement runs experiments'},
  { id:'n11', phase:'transformation', num:'16', title:'QATT Card',                            subtitle:'ATAM-style scenario card: quality attribute, stimulus source, environment, measurable response, trade-offs, and architectural tactics used',                link:'https://iasa-global.github.io/btabok/qatt_card.html',                    badge:'BTABoK', importancy:1, importancyReason:'Quality attributes ARE architecture — stimulus-response scenarios make NFRs testable and prevent them from being ignored until production', note:'One card per quality attribute scenario', recurring:true},
  { id:'n12', phase:'transformation', num:'17', title:'Architecture Definition Canvas',       subtitle:'Single-page alignment artifact defining what architecture means for the engagement and its value to each stakeholder group',                 link:'https://iasa-global.github.io/btabok/architecture_definition_canvas.html', badge:'BTABoK', importancy:1, importancyReason:'Single-page alignment artifact that prevents scope creep and keeps all stakeholders working from the same architecture frame'},
  { id:'n13', phase:'transformation', num:'18', title:'Solution Design Canvas',               subtitle:'Structures solution exploration around business problem, desired outcomes, solution options, success metrics, and key assumptions to validate',                               link:'https://iasa-global.github.io/btabok/solution_design_canvas.html',        badge:'BTABoK', importancy:1, importancyReason:'Forces structured option analysis before committing to a solution — without it, the first idea wins by default', note:'Spans Planning → Transformation continuously'},
  { id:'n14', phase:'transformation', num:'19', title:'ADR Card',                             subtitle:'Auditable record of an architectural decision: context, compared options, rationale, consequences, status, and traceability to ASRs',                  link:'https://iasa-global.github.io/btabok/architecture_decision_record.html',                                                                                             badge:'BTABoK', importancy:1, importancyReason:'The definitive audit trail of why the architecture is the way it is — missing ADRs mean future teams reverse decisions blindly', note:'Core — new ADR for every significant decision in Planning and Transformation', recurring:true},
  { id:'n15', phase:'transformation', num:'20', title:'Architecture Decision Cascade Card',   subtitle:'Tracks secondary decisions and downstream consequences flowing from a primary ADR.',                   link:'https://iasa-global.github.io/btabok/architecture_decision_cascade_card.html', badge:'BTABoK', importancy:2, importancyReason:'Important companion to ADR for high-impact decisions, but secondary — value scales with decision complexity rather than being universally mandatory', note:'Core — one Cascade Card per ADR, in both phases', recurring:true},
  { id:'n16', phase:'transformation', num:'21', title:'Bounded Context Canvas',               subtitle:'DDD boundaries, language, dependencies',                       link:'https://github.com/ddd-crew/bounded-context-canvas',                                                                 badge:'DDD', importancy:1, importancyReason:'Service decomposition without explicit DDD boundaries produces integration spaghetti — contexts must be named and owned before interfaces are designed', note:'One canvas per bounded context in the domain', recurring:true},
  { id:'n28', phase:'transformation', num:'22', title:'Container / Component View (C4 L2-L3)',subtitle:'System decomposed into containers and components, responsibilities', link:'https://c4model.com/#ContainerDiagram',                               badge:'C4', importancy:1, importancyReason:'Structural decomposition is a non-negotiable viewpoint — without it, Context View jumps straight to code with no intermediate accountability', note:'BTABoK gap: structural decomposition (Views & Viewpoints) — use C4 Container + Component Diagrams; bridges Context View to service interfaces', external:true},
  { id:'n17', phase:'transformation', num:'23', title:'Service Interface Design Canvas',      subtitle:'Outside-in service specification: value proposition, consumers, interactions, SLAs, dependencies, quality attributes, rules, and consumption economics',                       link:'https://iasa-global.github.io/btabok/service_interface_design_canvas.html',     badge:'BTABoK', importancy:1, importancyReason:'Contracts between services are the hardest things to change after deployment — explicit interface design prevents accidental coupling', note:'One canvas per service, API, or product delivered by a team', recurring:true},
  { id:'n18', phase:'transformation', num:'25', title:'Deployment / Infrastructure View',     subtitle:'Components mapped to nodes, networks, environments',           link:'https://c4model.com/#DeploymentDiagram',                                                                             badge:'C4', importancy:1, importancyReason:'Architecture exists in a physical environment — without this view, operational concerns (latency, failure domains, compliance) are invisible until production', note:'BTABoK gap: physical view (Views & Viewpoints) — use C4 Deployment or UML Deployment Diagram', external:true},
  { id:'n29', phase:'transformation', num:'24', title:'Security Architecture View',           subtitle:'Threat model, trust zones, security controls, attack surface', link:'https://owasp.org/www-community/Threat_Modeling',                        badge:'OWASP', importancy:1, importancyReason:'Security bolted on after design is a compliance liability and a re-architecture event — threat modelling must happen at transformation phase', note:'BTABoK gap: security viewpoint — use STRIDE threat model + security zone diagram; critical for compliance and risk closure', external:true},
  { id:'n20', phase:'transformation', num:'26', title:'Sequence / Scenario View',             subtitle:'Time-ordered message flow for key use cases',                  link:'https://c4model.com/#DynamicDiagram',                                                                                badge:'C4', importancy:1, importancyReason:'Dynamic behaviour verification catches integration failures and timing assumptions before they reach production', note:'BTABoK gap: scenario view (Views & Viewpoints) — use UML Sequence or C4 Dynamic Diagram', external:true, recurring:true},
  { id:'n21', phase:'transformation', num:'27', title:'Technical Loan Request Card',          subtitle:'Formalises technical debt as a deliberate loan: business justification, impact analysis, repayment schedule in work days, and approval trail',          link:'https://iasa-global.github.io/btabok/technical_loan_request_card.html',  badge:'BTABoK', importancy:1, importancyReason:'Explicit debt management is a professional obligation — treating shortcuts as loans with a repayment plan keeps architectural integrity visible to business', note:'One card per technical debt item', recurring:true},

  // BTABoK Utilize phase artifacts
  { id:'n22', phase:'utilize',        num:'28', title:'Benefits Realization View Canvas',     subtitle:'Links architecture investments to measurable business benefits through a model covering costs, benefits, technical investments, and technical debt',          link:'https://iasa-global.github.io/btabok/benefits_realization_view_canvas.html', badge:'BTABoK', importancy:1, importancyReason:'Closes the loop between architecture decisions and business outcomes — without it, architecture value is claimed but never demonstrated' },
];
