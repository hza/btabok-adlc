...
export const NODES: NodeData[] = [
  ...
  { id:'n07', phase:'strategy',       num:'11', title:'Layered Roadmap Canvas',               subtitle:'Current → target state, phased investment gates',              link:'https://iasa-global.github.io/btabok/layered_roadmap_canvas.html',        badge:'BTABoK', importancy:1, importancyReason:'Transforms architecture intent into funded, sequenced delivery — without it strategy remains aspirational and unbudgeted'},
  { id:'n08', phase:'planning',       num:'12', title:'Context View Card',                    subtitle:'System boundary, external actors, interfaces',                 link:'https://iasa-global.github.io/btabok/context_view_card.html',           badge:'BTABoK', importancy:1, importancyReason:'Establishes the system boundary before any design begins — misaligned scope is the most expensive planning mistake to fix later'},
  { id:'n26', phase:'planning',       num:'13', title:'Service Blueprint Canvas',             subtitle:'Customer journey, front/back-stage systems, failure points',   link:'https://iasa-global.github.io/btabok/service_blueprint_canvas.html',      badge:'BTABoK', importancy:1, importancyReason:'Bridges customer experience to back-stage systems — the primary artifact for aligning service architecture with actual usage and failure modes', note:'One canvas per customer journey or service scenario', recurring:true},
  { id:'n09', phase:'planning',       num:'14', title:'ASR Card',                             subtitle:'Architecturally significant requirements',                     link:'https://iasa-global.github.io/btabok/asr_card.html',                     badge:'BTABoK', importancy:1, importancyReason:'ASRs are the contractual interface between business needs and architecture decisions — every ADR must trace back to one', note:'One card per architecturally significant requirement', recurring:true},
  { id:'n10', phase:'planning',       num:'15', title:'Architecture Hypothesis Canvas',       subtitle:'Assumption → experiment → success metric',                     link:'https://iasa-global.github.io/btabok/architecture_hypothesis_card.html', badge:'BTABoK', importancy:2, importancyReason:'Valuable in lean/agile contexts for validating uncertain decisions, but conditional on methodology — not every engagement runs experiments'},
  { id:'n11', phase:'planning',       num:'16', title:'QATT Card',                            subtitle:'Stimulus–response quality attribute scenarios',                link:'https://iasa-global.github.io/btabok/qatt_card.html',                    badge:'BTABoK', importancy:1, importancyReason:'Quality attributes ARE architecture — stimulus-response scenarios make NFRs testable and prevent them from being ignored until production', note:'One card per quality attribute scenario', recurring:true},
  ...
  { id:'n17', phase:'transformation', num:'23', title:'Service Interface Design Canvas',      subtitle:'Operations, contracts, SLAs, consumers',                       link:'https://iasa-global.github.io/btabok/service_interface_design_canvas.html',     badge:'BTABoK', importancy:1, importancyReason:'Contracts between services are the hardest things to change after deployment — explicit interface design prevents accidental coupling', note:'One canvas per service, API, or product delivered by a team', recurring:true},
