...
export const NODES: NodeData[] = [
  ...
  { id:'n33', phase:'innovation',       num:'04c', title:'JBTD Card',                              subtitle:'Captures the functional, emotional, and social jobs customers are trying to accomplish — independent of any solution — to anchor architecture to genuine customer needs rather than assumed features',  link:'https://iasa-global.github.io/btabok/jtbd_card.html',               badge:'BTABoK', importancy:1, importancyReason:'Architecture built around solutions rather than customer jobs optimises the wrong things; JTBD reframes every requirement as a job the customer is trying to get done', note:'One card per distinct customer job; identify functional, emotional, and social dimensions', recurring:true},
