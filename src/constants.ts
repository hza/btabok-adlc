...
export const DEFAULT_SCALE = 0.72;  // Chosen so that the initial layout fits well on a 1080p screen, but users can zoom in for more detail or zoom out to see the overall structure.
